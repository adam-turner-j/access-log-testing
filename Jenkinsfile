properties([
  parameters([
    ...
    string(name: 'source_endpoint', defaultValue: 's3-accesspoint.us-gov-west-1.amazonaws.com', description: ''),
    string(name: 'dest_endpoint', defaultValue: 's3-accesspoint.us-gov-west-1.amazonaws.com', description: ''),
  ])
])
